<h2><a href="https://leetcode.com/problems/additive-number/description/">306. Additive Number</a></h2><h3>Medium</h3><hr><p>An <strong>additive number</strong> is a string whose digits can form an <strong>additive sequence</strong>.</p>
